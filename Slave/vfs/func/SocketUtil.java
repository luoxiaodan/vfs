...
public class SocketUtil {
	...
	public static void deleteChunk(DataOutputStream out, DataInputStream in, Slave slave)
	...
	public static boolean deleteCopyChunk(String Slave_IP, int port, int chunkid)
			throws UnknownHostException, IOException {
		boolean flag = false;
		Socket socket = new Socket(Slave_IP, port);
		DataOutputStream out = new DataOutputStream(socket.getOutputStream());
	...
	public static boolean TocreateCopyChunk(String Slave_IP, int port, JSONObject chunk)
			throws UnknownHostException, IOException {
